...
another problem was that i didnt realise how heavy the images generated where it ended up taking all of my 5 dollars and i had no idea. anyway I still dont know if thats why i am receiving errors the moment i put it render. I had this aspect where the image downloaded after rendering and did not relaise how much it was costing me, but you can left click, save image as and it will be able to save it as png. at first it saved in a folder name static did not realise how heavy it was. 

Wverything was working and then trying to make it wokr on render was hard. it worked in class but now it ws to heavy and it would automatically kill itself because i had no space and it was hard to figure out how to fix it, as I knew it was because of the image implemenation.
